      ...
      <div className="mx-auto max-w-[1280px] px-6 lg:px-8 h-14 flex items-center justify-between">
        ...
        >
          ...
          >
            ...
            <path d="M14 28C21.732 28 28 21.732 28 14C28 6.26801 21.732 0 14 0C6.26801 0 0 6.26801 0 14C0 21.732 6.26801 28 14 28Z" fill="#b5e38e"/>
            <g clipPath="url(#clip0_323_1068)">
              <path d="M66.0649 60C62.2347 60 59.1298 63.1213 59.1298 66.9717C59.1298 70.822 62.2347 73.9434 66.0649 73.9434C69.895 73.9434 73 70.822 73 66.9717C73 63.1213 69.895 60 66.0649 60Z" fill="#b5e38e"/>
